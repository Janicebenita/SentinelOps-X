import type {Audit,AuditPackage,Evidence,EvidenceLink,Health,Incident,Hypothesis,NexusAgent,NexusAuditV1,NexusEvidenceV1,NexusRun,NexusTelemetry,NexusTwin,Patch,PullRequest,ReplayRun,RoleVerification,ScenarioResult,Scorecard,Tournament,TwinManifest,Verification} from '../types'
declare global{interface Window{__SENTINELOPS_CONFIG__?:{API_BASE_URL?:string}}}
const BASE=(window.__SENTINELOPS_CONFIG__?.API_BASE_URL||import.meta.env.VITE_API_BASE_URL||'').replace(/\/$/,'')
