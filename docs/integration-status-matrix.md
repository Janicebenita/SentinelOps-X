...
| Vertex AI | LOCAL_ADAPTER_ONLY | authoritative bounded linear forecast |
| BigQuery | LOCAL_ADAPTER_ONLY | local operational database/export |
...
| OpenTelemetry | LOCAL_ADAPTER_ONLY | local trace IDs/invocation records |
